...
import cn.net.easyinfo.bean.*;
import cn.net.easyinfo.bean.Menu;
import cn.net.easyinfo.service.*;
...
public class SystemBasicController {
    ...
    public  List<Menu> menuTree(@PathVariable Long rid) {
       /* Map<String, Object> map = new HashMap<>();
        ...
        return map;*/
        return menuService.getMenuTreeByPid(rid);
    }
    @RequestMapping(value = "/menuTree/rid/{rid}", method = RequestMethod.GET)
   public Map<String, Object> menuTreeRid(@PathVariable Long rid) {
        Map<String, Object> map = new HashMap<>();
        List<Long> selMids = menuService.getMenusByRid(rid);
        map.put("mids", selMids);
        return map;
